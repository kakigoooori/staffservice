...
<form method="post" action="/agreement/done/{{$input['id'] }}" enctype="multipart/form-data">
<br>
...
<ul class="nav nav-tabs">
  ...
  <li class="nav-item">
    <a class="nav-link active" href="">契約</a>
  </li>
  <li class="nav-item">
...
<h4 style="text-align:center;"><b>『契約』</b></h4>
...
@else
<input type="text" name="time" value="{{ $skilldata[0]->time }}">
@endempty
</div>
</th>
</tr>
...
<div class="form-group"> 
@empty($skilldata[0])   
<input type="text" name="break" value="{{ old('break' ) }}">
@else
<input type="text" name="break" value="{{ $skilldata[0]->break }}">
@endempty
</div>
</th>
</tr>
...
@else
<input type="text" name="overtime" value="{{ $skilldata[0]->overtime }}">
@endempty
</div>
</th>
</tr>
...
<div class="form-group"> 
<p><b>休日</b></p>
<input type="text" name="holiday" value="{{ $skilldata[0]->holiday }}" size="35">
</div>
<div class="form-group">
<p><b>休暇</b></p>
<input type="text" name="paid" value="{{ $skilldata[0]->paid }}" size="35">
</div>
<div class="form-group">
<p><b>その他</b></p>
<input type="text" name="other" value="{{ $skilldata[0]->other }}" size="35">
</div>
