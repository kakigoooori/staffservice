...
<!-- ▼郵便番号入力フィールド(7桁) -->
<div class="form-group">  
<input type="text" name="zip01" size="10" maxlength="8" onKeyUp="AjaxZip3.zip2addr(this,'','pref01','addr01');">郵便番号(７桁)
</div> 
<!-- ▼住所入力フィールド(都道府県) -->
<div class="form-group">  
<input type="text" name="pref01" size="20">都道府県
</div> 
<!-- ▼住所入力フィールド(都道府県以降の住所) -->
<div class="form-group">  
<input type="text" name="addr01" size="60">以降の住所
</div> 
...
<input id="mobiletel" type="mobiletel"  name="mobiletel" value="{{ old('mobiletel') }}" >
...
<input id="email" type="mobiletel"  name="email" value="{{ old('email') }}" >
...
<input id="mobilemail" type="mobilemail"  name="mobilemail" value="{{ old('mobilemail') }}" >
...
<div class="form-group">           
<input type="time" name="start_time" step="600">～<input type="time"  name="end_time" step="600">
</div>
